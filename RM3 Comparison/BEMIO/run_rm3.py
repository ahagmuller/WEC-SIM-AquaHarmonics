...
# One body
nemoh_data_one_body = read(sim_dir='./data/rm32', cal_file='Nemoh.cal', results_dir='Results', mesh_dir='Mesh')
nemoh_data_one_body.read_hydrostatics(body_num=0,file='./data/rm32/Mesh/Hydrostatics.dat')
nemoh_data_one_body.read_kh(body_num=0, file='./data/rm32/Mesh/KH.dat')

for i in xrange(nemoh_data_one_body.body[0].num_bodies):
	nemoh_data_one_body.body[i].calc_irf_radiation(t_end=200., n_t=1001, n_w=501)
	nemoh_data_one_body.body[i].calc_irf_excitation(t_end=200., n_t=1001, n_w=501)
	nemoh_data_one_body.body[i].calc_ss_radiation()
