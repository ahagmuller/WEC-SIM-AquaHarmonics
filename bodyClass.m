    ...
    properties (SetAccess = 'public', GetAccess = 'public') %input file
        ...
        mooring           = struct('c',          zeros(6,6), ...                % Mooring damping, 6 x 6 matrix
                                    'k',          0*[10 -1 00 00 00 2
                                                   ...
                                                   00 00 00 00 00 00
                                                   00 00 00 00 00 00
                                                   18 -160 00 00 00 103], ...               % Mooring stiffness, 6 x 6 matrix
                                                     'preTension', 000)       
                                
                                
                               %zeros(6,6)% Mooring preTension, Vector length 6
        viscDrag          = struct('cd',                   [.65 .65 .5 0 0 0], ...   % Viscous (quadratic) drag cd, vector length 6
                                    'characteristicArea',   [55 55 177 0 0 0])      % Characteristic area for viscous drag, vector length 6
        initDisp          = struct('initLinDisp',          [0 0 2.5], ...         % Initial displacement of center fo gravity - used for decay tests (format: [displacment in m], default = [0 0 0])
        ...
        linearDamping     = [1000 1000 1000 1000 1000 1000]                                       % Linear drag coefficient, vector length 6
